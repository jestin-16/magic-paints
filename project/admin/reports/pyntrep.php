...
<body>
    ...
    <div class="container">
        ...
        $ssql="SELECT  `Name` FROM `bookingdetails` WHERE `id`='$a[site_id]'";
        $sres=mysqli_query($con,$ssql);
        $b=mysqli_fetch_array($sres);
        ...
        if (!$res) {
            ...
            echo "<thead><tr><th>Date</th><th>Total Amount</th><th>Site ID</th><th>Total</th><th>Actions</th></tr></thead>";
            echo "<tbody>";
            while ($x = mysqli_fetch_array($res)) {
                ...
                echo "<td>" . $x['total'] . "</td>";
                echo "<td><a href='site_details.php?site_id=" . $b['Name'] . "' class='btn btn-info btn-view'>View Details</a></td>";
                echo "</tr>";
            }
