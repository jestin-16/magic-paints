...
<body>
    ...
    <div class="container table-container">
        ...
        <?php
        $sql = "SELECT id, username, Name, phoneNo, address, build_type, work_type, sqfeet, status FROM `bookingdetails`";
                    ...
                    <form id="editForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="workType">
                                ...
                                <!-- Add any other work type options that exist in your database -->
                            </select>
                        </div>
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-btn').click(function () {
                ...
                // Fix for Work Type dropdown
                var workTypeValue = row.find('.work-type').text().trim();
                $('#workType').val(workTypeValue);
                $('#squareFeet').val(row.find('.sqfeet').text());
                // Fix for Status dropdown
                var statusValue = row.find('.status').text().trim();
